...
void setup() {
  ...
  background (random(color1.hue(), color2.hue()), random(color1.saturation(), color2.saturation()), random(color1.brightness(), color2.brightness()));

  stroke(random(color4.hue(), color5.hue()), random(color4.saturation(), color5.saturation()), random(color4.brightness(), color5.brightness()));
  strokeWeight (.75);
